...
@Configuration
@EnableJpaRepositories("org.uce.fimeped.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    public DataSource dataSource() {
        ...
        if ("com.microsoft.sqlserver.jdbc.SQLServerDataSource".equals(dataSourcePropertyResolver.getProperty("dataSourceClassName"))) {
